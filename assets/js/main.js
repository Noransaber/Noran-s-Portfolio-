...
document.addEventListener('DOMContentLoaded', () => {
  emailjs.init('8S0l_ZVruyeF0gYO8'); // Initialize EmailJS with your public key
  ...
  form.addEventListener('submit', async (event) => {
    ...
    try {
      const response = await emailjs.send('service_g4q328t', 'template_60smv03', {
        to_name: 'Noran', // Your name (receiver's name)
        from_name: name, // Sender's name from the form
        from_email: email, // Sender's email from the form
